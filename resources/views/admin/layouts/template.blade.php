...
<head>
    ...
    <!-- Javascript Assets -->
    <script src="/assets/admin/js/app.js" defer></script>
...
<body x-data class="is-header-blur" x-bind="$store.global.documentBody">
    ...
    <div id="root" class="min-h-100vh flex grow bg-slate-50" x-cloak>
      ...
      <!-- Sidebar -->
                ...
                <div
                    ...
                    <div class="flex pt-4">
                        <a href="index.html">
                            <img class="size-11 transition-transform duration-500 ease-in-out hover:rotate-[360deg]"
                                src="/assets/admin/images/app-logo.svg" alt="logo" />
                        </a>
                    </div>
                    ...
                    <div class="is-scrollbar-hidden flex grow flex-col space-y-4 overflow-y-auto pt-6">
                        ...
                        <a href="dashboards-crm-analytics.html"
                            class="flex size-11 items-center justify-center rounded-lg bg-primary/10 text-primary outline-none transition-colors duration-200 hover:bg-primary/20 focus:bg-primary/20 active:bg-primary/25"
                        ...
                        <a href="apps-list.html"
                            class="flex size-11 items-center justify-center rounded-lg outline-none transition-colors duration-200 hover:bg-primary/20 focus:bg-primary/20 active:bg-primary/25"
                    ...
                    <div class="flex flex-col items-center space-y-3 py-3">
                        ...
                        <div x-data="usePopper({ placement: 'right-end', offset: 12 })" @click.outside="isShowPopper && (isShowPopper = false)"
                            ...
                            <button @click="isShowPopper = !isShowPopper" x-ref="popperRef" class="avatar size-12">
                                <img class="rounded-full" src="/assets/admin/images/avatar/avatar-12.jpg"
                                    alt="avatar" />
                                <span
        ...
        <!-- App Header Wrapper-->
        <nav class="header before:bg-white print:hidden">
            <!-- App Header  -->
                ...
                <div class="flex w-full items-center justify-between">
                    ...
                    <div class="-mr-1.5 flex items-center space-x-2">
                                        ...
                                        <div class="is-scrollbar-hidden overflow-y-auto overscroll-contain pb-2">
                                            <div class="is-scrollbar-hidden mt-3 flex space-x-4 overflow-x-auto px-3">
                                                ...
                                                <a href="dashboards-banking-1.html" class="w-14 text-center">
                                                    <div class="avatar size-12">
                                                        <div
                                                            class="is-initial rounded-full bg-primary text-white">
                                                            <svg xmlns="http://www.w3.org/2000/svg" class="size-5"
                                                                fill="none" viewBox="0 0 24 24"
                                                                stroke="currentColor" stroke-width="2">
                                                                <path stroke-linecap="round" stroke-linejoin="round"
                                            ...
                                            <div class="mt-1 font-inter font-medium">
                                                <a class="group flex items-center space-x-2 px-2.5 py-2 tracking-wide outline-none transition-all hover:bg-slate-100 hover:text-slate-800 focus:bg-slate-100 focus:text-slate-800"
                                                    href="apps-chat.html">
                                                    <svg xmlns="http://www.w3.org/2000/svg"
                                                        class="size-4.5 text-slate-400 transition-colors group-hover:text-slate-500 group-focus:text-slate-500"
                                                        fill="none" viewBox="0 0 24 24" stroke="currentColor"
                                                        stroke-width="1.5">
                                                        <path stroke-linecap="round" stroke-linejoin="round"
                                                            d="M8 12h.01M12 12h.01M16 12h.01M21 12c0 4.418-4.03 8-9 8a9.863 9.863 0 01-4.255-.949L3 20l1.395-3.72C3.512 15.042 3 13.574 3 12c0-4.418 4.03-8 9-8s9 3.582 9 8z" />
                        ...
                        <div x-effect="if($store.global.isSearchbarActive) isShowPopper = false"
                            x-data="usePopper({ placement: 'bottom-end', offset: 12 })" @click.outside="isShowPopper && (isShowPopper = false)"
                            class="flex">
                            <button @click="isShowPopper = !isShowPopper" x-ref="popperRef"
                                ...
                                <svg xmlns="http://www.w3.org/2000/svg"
                                    class="size-5 text-slate-500" stroke="currentColor"
                                    fill="none" viewBox="0 0 24 24">
                            ...
                            <div :class="isShowPopper && 'show'" class="popper-root" x-ref="popperRoot">
                                <div x-data="{ activeTab: 'tabAll' }"
                                    ...
                                    <div
                                        class="rounded-t-lg bg-slate-100 text-slate-600">
                                        ...
                                        <div x-show="activeTab === 'tabAll'"
                                            ...
                                            <div class="flex items-center space-x-3">
                                                <div
                                                    ...
                                                    <i
                                                        class="fa fa-user-edit text-secondary"></i>
                                                </div>
                                                <div>
                                            ...
                                            <div class="flex items-center space-x-3">
                                                ...
                                                <div>
                                                    ...
                                                    <div class="mt-1 flex text-xs text-slate-400">
                                                        ...
                                                        <div class="mx-2 my-1 w-px bg-slate-200">
                                                        </div>
                                            ...
                                            <div class="flex items-center space-x-3">
                                                <div
                                                    ...
                                                    <i
                                                        class="fa-solid fa-image text-primary"></i>
                                                </div>
                                                <div>
                                                    <p class="font-medium text-slate-600">
                                                        Images Added
                                        ...
                                        <div x-show="activeTab === 'tabLogs'"
                                            ...
                                            <div class="mt-8 pb-8 text-center">
                                                <img class="mx-auto w-36"
                                                    src="/assets/admin/images/illustrations/empty-girl-box.svg"
                                                    alt="image" />
                                                <div class="mt-5">
                                                    <p
        ...
        <div x-show="$store.breakpoints.isXs && $store.global.isSearchbarActive"
            ...
            <div class="flex items-center space-x-2 bg-slate-100 px-3 pt-2">
                ...
                <input x-effect="$store.global.isSearchbarActive && $nextTick(() => $el.focus() );"
                    class="form-input h-8 w-full bg-transparent placeholder-slate-400"
        ...
        <div x-show="$store.global.isRightSidebarExpanded"
            ...
            <div class="fixed right-0 top-0 z-[151] h-full w-full sm:w-80">
                <div x-data="{ activeTab: 'tabHome' }"
                    class="relative flex h-full w-full transform-gpu flex-col bg-white transition-transform duration-200"
                    ...
                    <div class="flex items-center justify-between py-2 px-4">
                        ...
                        <button @click="$store.global.isRightSidebarExpanded=false"
                            class="btn -mr-1 size-6 rounded-full p-0 hover:bg-slate-300/20 focus:bg-slate-300/20 active:bg-slate-300/25">
                            <svg xmlns="http://www.w3.org/2000/svg" class="size-4" fill="none"
                                viewBox="0 0 24 24" stroke="currentColor" stroke-width="2">
                    ...
                    <div x-show="activeTab === 'tabHome'"
                        ...
                        <label class="relative flex px-3">
                            <input
                                class="form-input peer h-8 w-full rounded-lg bg-slate-150 px-3 py-2 pl-9 text-xs+ ring-primary/50 placeholder:text-slate-400 hover:bg-slate-200 focus:ring"
                        ...
                        <div class="mt-3">
                            <h2
                                class="px-3 text-xs+ font-medium tracking-wide text-slate-700 line-clamp-1">
                                Banking cards
                            </h2>
                            <div class="swiper mt-3 px-3" x-init="$nextTick(() => new Swiper($el, { slidesPerView: 'auto', spaceBetween: 16 }))">
                                <div class="swiper-wrapper">
                                    <div
                                        ...
                                        <div class="grow">
                                            <img class="h-3"
                                                src="/assets/admin/images/payments/cc-visa-white.svg"
                                                alt="image" />
                                        </div>
                        ...
                        <div class="mt-4 px-3">
                            <h2
                                class="text-xs+ font-medium tracking-wide text-slate-700 line-clamp-1">
                                Pinned Apps
                            </h2>
                        ...
                        <div class="mt-4">
                            <div class="grid grid-cols-2 gap-3 px-3">
                                <div class="rounded-lg bg-slate-150 px-2.5 py-2">
                                    <div class="flex items-center justify-between space-x-1">
                                        <p>
                                            <span
                                                class="text-lg font-medium text-slate-700">11.3</span>
                                    ...
                                    <div class="progress mt-3 h-1.5 bg-secondary/15">
                                        <div
                                            class="is-active relative w-8/12 overflow-hidden rounded-full bg-secondary">
                                        </div>
                                    </div>

                                    <div
                                        class="mt-1.5 flex items-center justify-between text-xs text-slate-400">
                                        <button
                                            class="btn -ml-1 size-6 rounded-full p-0 hover:bg-slate-300/20 focus:bg-slate-300/20 active:bg-slate-300/25">
                                            <svg xmlns="http://www.w3.org/2000/svg" class="size-4" fill="none"
                                                viewBox="0 0 24 24" stroke="currentColor" stroke-width="1.5">
                                                <path stroke-linecap="round" stroke-linejoin="round"
                                                    d="M10.325 4.317c.426-1.756 2.924-1.756 3.35 0a1.724 1.724 0 002.573 1.066c1.543-.94 3.31.826 2.37 2.37a1.724 1.724 0 001.065 2.572c1.756.426 1.756 2.924 0 3.35a1.724 1.724 0 00-1.066 2.573c.94 1.543-.826 3.31-2.37 2.37a1.724 1.724 0 00-2.572 1.065c-.426 1.756-2.924 1.756-3.35 0a1.724 1.724 0 00-2.573-1.066c-1.543.94-3.31-.826-2.37-2.37a1.724 1.724 0 00-1.065-2.572c-1.756-.426-1.756-2.924 0-3.35a1.724 1.724 0 001.066-2.573c-.94-1.543.826-3.31 2.37-2.37.996.608 2.296.07 2.572-1.065z" />
                                ...
                                <div class="rounded-lg bg-slate-150 px-2.5 py-2">
                                    <div class="flex items-center justify-between space-x-1">
                                        <p>
                                            <span
                                                class="text-lg font-medium text-slate-700">13</span>
                                    ...
                                    <div class="progress mt-3 h-1.5 bg-success/15">
                        ...
                        <div class="mt-4">
                            ...
                            <div class="mt-3 grid grid-cols-2 gap-3 px-3">
                                <div class="rounded-lg bg-slate-100 p-2.5">
                                    <div class="flex items-center space-x-2">
                                        <img class="size-10" src="/assets/admin/images/logos/bitcoin.svg"
                                            alt="image" />
                                        <div>
                                ...
                                <div class="rounded-lg bg-slate-100 p-2.5">
                                    <div class="flex items-center space-x-2">
                                        <img class="size-10" src="/assets/admin/images/logos/solana.svg"
                                            alt="image" />
                                        <div>
                                            <h2 class="font-medium tracking-wide text-slate-700">
                                                SOL
                        ...
                        <div class="mt-4">
                            ...
                            <div class="mt-3 space-y-3 px-2">
                                <div
                                    class="flex justify-between space-x-2 rounded-lg bg-slate-100 p-2.5">
                                    <div class="flex flex-1 flex-col justify-between">
                                        <div class="line-clamp-2">
                                            <a href="#"
                                                class="font-medium text-slate-700 hover:text-primary focus:text-primary">What
                                                is Tailwind CSS?</a>
                                        </div>
                                            ...
                                            <div class="flex items-center space-x-2">
                                                <div class="avatar size-7">
                                                    <img class="rounded-full"
                                                        src="/assets/admin/images/avatar/avatar-20.jpg"
                                                        alt="avatar" />
                                                </div>
                                                <div>
                                                    ...
                                                    <p
                                                        class="text-tiny+ text-slate-400 line-clamp-1">
                                                        2 min read
                                                    </p>
                                                </div>
                                            </div>
                                    ...
                                    <img src="/assets/admin/images/object/object-18.jpg"
                                ...
                                <div
                                    ...
                                    <div class="flex flex-1 flex-col justify-between">
                                        <div class="line-clamp-2">
                                            <a href="#"
                                                class="font-medium text-slate-700 hover:text-primary focus:text-primary">Tailwind
                                                CSS Card Example</a>
                                        </div>
                                        <div class="flex items-center justify-between">
                                            <div class="flex items-center space-x-2">
                                                <div class="avatar size-7">
                                                    <img class="rounded-full"
                                                        src="/assets/admin/images/avatar/avatar-19.jpg"
                                                        alt="avatar" />
                                                </div>
                                                <div>
                                                    <p class="text-xs font-medium line-clamp-1">
                                    ...
                                    <img src="/assets/admin/images/object/object-2.jpg"
                                        class="size-20 rounded-lg object-cover object-center" alt="image" />
                                </div>
                                ...
                                <div
                                    ...
                                    <div class="flex flex-1 flex-col justify-between">
                                        <div class="line-clamp-2">
                                            <a href="#"
                                                class="font-medium text-slate-700 hover:text-primary focus:text-primary">10
                                        ...
                                        <div class="flex items-center justify-between">
                                            <div class="flex items-center space-x-2">
                                                <div class="avatar size-7">
                                                    <img class="rounded-full"
                                                        src="/assets/admin/images/avatar/avatar-18.jpg"
                                                        alt="avatar" />
                                                </div>
                                                <div>
                                                    <p class="text-xs font-medium line-clamp-1">
                                    ...
                                    <img src="/assets/admin/images/object/object-1.jpg"
                                        class="size-20 rounded-lg object-cover object-center" alt="image" />
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="mt-3 px-3">
                            <div class="rounded-lg bg-slate-100 p-3">
                                <div class="flex items-center justify-between">
                                    <p>
                                        <span class="font-medium text-slate-600">35GB</span>
                                        of 1TB
                                    </p>
                                    <a href="#"
                                        class="text-xs+ font-medium text-primary outline-none transition-colors duration-300 hover:text-primary/70 focus:text-primary/70">Upgrade</a>
                                </div>

                                <div class="progress mt-2 h-2 bg-slate-150">
                    ...
                    <div x-show="activeTab === 'tabProjects'"
                            ...
                            <div class="rounded-lg bg-slate-100 p-3">
                                <div class="flex justify-between space-x-1">
                                    ...
                                    <svg xmlns="http://www.w3.org/2000/svg" stroke-width="1.5"
                                        class="size-5 text-primary" fill="none"
                                        viewBox="0 0 24 24" stroke="currentColor">
                                        <path stroke-linecap="round" stroke-linejoin="round"
                                            d="M12 8v4l3 3m6-3a9 9 0 11-18 0 9 9 0 0118 0z" />
                                    </svg>
                        ...
                        <div class="mt-4 rounded-lg border border-slate-150 p-3">
                            <div class="flex items-center space-x-3">
                                <img class="size-10 rounded-lg object-cover object-center"
                                    src="/assets/admin/images/illustrations/lms-ui.svg" alt="image" />
                                <div>
                                    <p class="font-medium leading-snug text-slate-700">
                                        LMS App Design
                                    </p>
                                    <p class="text-xs text-slate-400">
                                        Updated at 7 Sep
                            ...
                            <div class="mt-4">
                                <div class="progress h-1.5 bg-slate-150">
                                    <div class="w-4/12 rounded-full bg-primary"></div>
                                </div>
                                <p class="mt-2 text-right text-xs+ font-medium text-primary">
                                    25%
                                </p>
                            </div>
                                ...
                                <div class="flex -space-x-3">
                                    <div class="avatar size-7 hover:z-10">
                                        <img class="rounded-full ring ring-white"
                                            src="/assets/admin/images/avatar/avatar-16.jpg" alt="avatar" />
                                    </div>
                                    <div class="avatar size-7 hover:z-10">
                                        <div
                                    ...
                                    <div class="avatar size-7 hover:z-10">
                                        <img class="rounded-full ring ring-white"
                                            src="/assets/admin/images/avatar/avatar-20.jpg" alt="avatar" />
                                    </div>
                                </div>
                                <button
                        ...
                        <div class="mt-4 rounded-lg border border-slate-150 p-3">
                            <div class="flex items-center space-x-3">
                                <img class="size-10 rounded-lg object-cover object-center"
                                    src="/assets/admin/images/illustrations/store-ui.svg" alt="image" />
                                <div>
                                    <p class="font-medium leading-snug text-slate-700">
                                        Store Dashboard
                                    </p>
                            ...
                            <div class="mt-4">
                                <div class="progress h-1.5 bg-slate-150">
                                    <div class="w-6/12 rounded-full bg-primary"></div>
                                </div>
                                <p class="mt-2 text-right text-xs+ font-medium text-primary">
                                    49%
                                </p>
                            ...
                            <div class="mt-3 flex items-center justify-between space-x-2">
                                <div class="flex -space-x-3">
                                    <div class="avatar size-7 hover:z-10">
                                        <img class="rounded-full ring ring-white"
                                            src="/assets/admin/images/avatar/avatar-17.jpg" alt="avatar" />
                                    </div>
                                    <div class="avatar size-7 hover:z-10">
                                        <div
                                    ...
                                    <div class="avatar size-7 hover:z-10">
                                        <img class="rounded-full ring ring-white"
                                            src="/assets/admin/images/avatar/avatar-19.jpg" alt="avatar" />
                                    </div>
                                </div>
                                <button
                                    class="btn size-7 rounded-full bg-slate-150 p-0 font-medium text-slate-800 hover:bg-slate-200 focus:bg-slate-200 active:bg-slate-200/80">
                        ...
                        <div class="mt-4 rounded-lg border border-slate-150 p-3">
                            <div class="flex items-center space-x-3">
                                <img class="size-10 rounded-lg object-cover object-center"
                                    src="/assets/admin/images/illustrations/chat-ui.svg" alt="image" />
                                <div>
                                    <p class="font-medium leading-snug text-slate-700">
                                        Chat Mobile App
                                    </p>
                            ...
                            <div class="mt-4">
                                <div class="progress h-1.5 bg-slate-150">
                                    <div class="w-2/12 rounded-full bg-primary"></div>
                                </div>
                                <p class="mt-2 text-right text-xs+ font-medium text-primary">
                                    13%
                                </p>
                            ...
                            <div class="mt-3 flex items-center justify-between space-x-2">
                                <div class="flex -space-x-3">
                                    <div class="avatar size-7 hover:z-10">
                                        <img class="rounded-full ring ring-white"
                                            src="/assets/admin/images/avatar/avatar-5.jpg" alt="avatar" />
                                    </div>
                                    <div class="avatar size-7 hover:z-10">
                                        <div
                                    ...
                                    <div class="avatar size-7 hover:z-10">
                                        <img class="rounded-full ring ring-white"
                                            src="/assets/admin/images/avatar/avatar-11.jpg" alt="avatar" />
                                    </div>
                                </div>
                                <button
                                    class="btn size-7 rounded-full bg-slate-150 p-0 font-medium text-slate-800 hover:bg-slate-200 focus:bg-slate-200 active:bg-slate-200/80">
                        ...
                        <div class="mt-4 rounded-lg border border-slate-150 p-3">
                            <div class="flex items-center space-x-3">
                                <img class="size-10 rounded-lg object-cover object-center"
                                    src="/assets/admin/images/illustrations/nft.svg" alt="image" />
                                <div>
                                    <p class="font-medium leading-snug text-slate-700">
                                        NFT Marketplace App
                                    </p>
                            ...
                            <div class="mt-4">
                                <div class="progress h-1.5 bg-slate-150">
                                    <div class="w-9/12 rounded-full bg-primary"></div>
                                </div>
                                <p class="mt-2 text-right text-xs+ font-medium text-primary">
                                    78%
                                </p>
                            ...
                            <div class="mt-3 flex items-center justify-between space-x-2">
                                <div class="flex -space-x-3">
                                    <div class="avatar size-7 hover:z-10">
                                        <img class="rounded-full ring ring-white"
                                            src="/assets/admin/images/avatar/avatar-8.jpg" alt="avatar" />
                                    </div>
                                    <div class="avatar size-7 hover:z-10">
                                        <div
                                    ...
                                    <div class="avatar size-7 hover:z-10">
                                        <img class="rounded-full ring ring-white"
                                            src="/assets/admin/images/avatar/avatar-12.jpg" alt="avatar" />
                                    </div>
                                </div>
                                <button
                                    class="btn size-7 rounded-full bg-slate-150 p-0 font-medium text-slate-800 hover:bg-slate-200 focus:bg-slate-200 active:bg-slate-200/80">
                    ...
                    <div x-show="activeTab === 'tabActivity'"
                        ...
                        class="is-scrollbar-hidden overflow-y-auto overscroll-contain pt-1">
                        <div
                            class="mx-3 flex flex-col items-center rounded-lg bg-slate-100 py-3 px-8">
                            <svg xmlns="http://www.w3.org/2000/svg"
                                class="size-8 text-secondary" fill="none"
                                viewBox="0 0 24 24" stroke="currentColor" stroke-width="2">
                                <path stroke-linecap="round" stroke-linejoin="round"
                                    d="M12 8v4l3 3m6-3a9 9 0 11-18 0 9 9 0 0118 0z" />
                            </svg>
                            ...
                            <div class="progress mt-3 h-2 bg-secondary/15">
                                <div
                                    class="is-active relative w-8/12 overflow-hidden rounded-full bg-secondary">
                                </div>
                            </div>
                            ...
                            <button
                                class="btn mt-5 space-x-2 rounded-full border border-slate-300 px-3 text-xs+ font-medium text-slate-700 hover:bg-slate-150 focus:bg-slate-150 active:bg-slate-150/80">
                                <svg xmlns="http://www.w3.org/2000/svg"
                                    class="size-4.5 text-slate-400" fill="none"
                                    viewBox="0 0 24 24" stroke="currentColor" stroke-width="2">
                                    <path stroke-linecap="round" stroke-linejoin="round"
                        ...
                        <ol class="timeline line-space mt-5 px-4 [--size:1.5rem]">
                            <li class="timeline-item">
                                <div
                                    class="timeline-item-point rounded-full border border-current bg-white text-secondary">
                                    <i class="fa fa-user-edit text-tiny"></i>
                                </div>
                                <div class="timeline-item-content flex-1 pl-4">
                                    <div class="flex flex-col justify-between pb-2 sm:flex-row sm:pb-0">
                                        <p
                                            class="pb-2 font-medium leading-none text-slate-600 sm:pb-0">
                                            User Photo Changed
                                        </p>
                                        <span class="text-xs text-slate-400">12 minute ago</span>
                                    </div>
                            ...
                            <li class="timeline-item">
                                <div
                                    class="timeline-item-point rounded-full border border-current bg-white text-primary">
                                ...
                                <div class="timeline-item-content flex-1 pl-4">
                                    ...
                                    <div class="mt-4 grid grid-cols-3 gap-3">
                                        <img class="rounded-lg" src="/assets/admin/images/object/object-1.jpg"
                                            alt="image" />
                                        <img class="rounded-lg" src="/assets/admin/images/object/object-2.jpg"
                                            alt="image" />
                                        <img class="rounded-lg" src="/assets/admin/images/object/object-3.jpg"
                                            alt="image" />
                                        <img class="rounded-lg" src="/assets/admin/images/object/object-4.jpg"
                                            alt="image" />
                                        <img class="rounded-lg" src="/assets/admin/images/object/object-5.jpg"
                                            alt="image" />
                                        <img class="rounded-lg" src="/assets/admin/images/object/object-6.jpg"
                                            alt="image" />
                                    </div>
                                    <div class="mt-4">
                            ...
                            <li class="timeline-item">
                                <div
                                    class="timeline-item-point rounded-full border border-current bg-white text-success">
                                ...
                                <div class="timeline-item-content flex-1 pl-4">
                                    ...
                                    <a href="#"
                                        class="inline-flex items-center space-x-1 pt-2 text-slate-600 transition-colors hover:text-primary">
                                        <svg xmlns="http://www.w3.org/2000/svg" class="size-5" fill="none"
                                            viewBox="0 0 24 24" stroke="currentColor" stroke-width="1.5">
                                            <path stroke-linecap="round" stroke-linejoin="round"
                                    ...
                                    <div class="pt-2">
                                        <a href="#"
                                            class="tag rounded-full border border-secondary/30 bg-secondary/10 text-secondary hover:bg-secondary/20 focus:bg-secondary/20 active:bg-secondary/25">
                                            UI/UX
                                        </a>
                            ...
                            <li class="timeline-item">
                                <div
                                    class="timeline-item-point rounded-full border border-current bg-white text-warning">
                                ...
                                <div class="timeline-item-content flex-1 pl-4">
                                    <div class="flex flex-col justify-between pb-2 sm:flex-row sm:pb-0">
                                        ...
                                        <span class="text-xs text-slate-400">a day ago</span>
                                    </div>
                                    ...
                                    <div>
                                        ...
                                        <div class="mt-2 flex justify-between">
                                            <div class="flex flex-wrap -space-x-2">
                                                <div class="avatar size-7 hover:z-10">
                                                    <img class="rounded-full ring ring-white"
                                                        src="/assets/admin/images/avatar/avatar-16.jpg"
                                                        alt="avatar" />
                                                </div>
                                                ...
                                                <div class="avatar size-7 hover:z-10">
                                                    <img class="rounded-full ring ring-white"
                                                        src="/assets/admin/images/avatar/avatar-8.jpg"
                                                        alt="avatar" />
                                                </div>

                                                <div class="avatar size-7 hover:z-10">
                                                    <img class="rounded-full ring ring-white"
                                                        src="/assets/admin/images/avatar/avatar-5.jpg"
                                                        alt="avatar" />
                                                </div>
                                            </div>
                                            <button
                            ...
                            <li class="timeline-item">
                                <div
                                    class="timeline-item-point rounded-full border border-current bg-white text-error">
                    ...
                    <div class="pointer-events-none absolute bottom-4 flex w-full justify-center">
                        <div
                            class="pointer-events-auto mx-auto flex space-x-1 rounded-full border border-slate-150 bg-white px-4 py-0.5 shadow-lg">
                            <button @click="activeTab = 'tabHome'"
                                :class="activeTab === 'tabHome' && 'text-primary'"
                                class="btn h-9 rounded-full py-0 px-4 hover:bg-slate-300/20 hover:text-primary focus:bg-slate-300/20 focus:text-primary active:bg-slate-300/25">
                                ...
                                <svg x-show="activeTab !== 'tabHome'" xmlns="http://www.w3.org/2000/svg"
                                    class="size-5 shrink-0" fill="none" viewBox="0 0 24 24"
                            ...
                            <button @click="activeTab = 'tabProjects'"
                                :class="activeTab === 'tabProjects' && 'text-primary'"
                                class="btn h-9 rounded-full py-0 px-4 hover:bg-slate-300/20 hover:text-primary focus:bg-slate-300/20 focus:text-primary active:bg-slate-300/25">
                            ...
                            <button @click="activeTab = 'tabActivity'"
                                :class="activeTab === 'tabActivity' && 'text-primary'"
                                class="btn h-9 rounded-full py-0 px-4 hover:bg-slate-300/20 hover:text-primary focus:bg-slate-300/20 focus:text-primary active:bg-slate-300/25">
